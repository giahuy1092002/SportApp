...
namespace SportApp_Infrastructure.Migrations
{
    ...
    [Migration("20241219173306_AddIsAcceptSportField")]
    partial class AddIsAcceptSportField
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportApp_Domain.Entities.BanList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SportApp_Domain.Entities.Booking", b =>
                {
                    ...
                    b.Property<bool>("IsRejectByOwner")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SportApp_Domain.Entities.ReportRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SportApp_Domain.Entities.SportFieldVoucher", b =>
                {
                    b.Property<Guid>("SportFieldId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SportApp_Domain.Entities.SportProductRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SportProductVariantName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SportApp_Domain.Entities.SportFieldVoucher", b =>
                {
                    ...
                    b.HasOne("SportApp_Domain.Entities.Voucher", "Voucher")
                        .WithMany()
